          ...
          <div class="row no-gutters">
            <div class="col-md-6">
              <div class="hero-summery">
                ...
                <a
                  href="<?php echo get_field('home_page_banner')['more_details_link_reference_url']; ?>"
                  class="small-link"
                >
                  Get Quoute
                </a>
                ...
                <a
                  ...
                  href="<?php echo get_field('home_page_banner')['button_url']; ?>"
                >
                  <i class="fa fa-caret-right"></i>Find Out More{" "}
                </a>{" "}
                <br /> <br />
              </div>
            </div>
            ...
            <div class="col-md-6 offer-wrapper mobile-offer">
              <div class="offer-block-sm">
                <div class="offer-title">
                  <img
                    class="lazyload"
                    data-src="<?php echo assets_url(); ?>/assets/img/banner_summerSale.svg"
                    alt="Summer Sale"
                  />
                </div>
                <div class="offer-description">
                  <div class="offer-amount">
                    <img
                      class="lazyload"
                      data-src="<?php echo assets_url(); ?>/assets/img/banner_20Off.svg"
                      alt="20% Off"
                    />
                  </div>
      ...
      <div class="trust-builder">
        <div class="wrapper d-flex">
          ...
          <div class="trust-logos">
            ...
            <img
              class="lazyload awards-defecto"
              src="<?PHP echo assets_url(); ?>/assets/img/loader_352_198.gif"
              data-src="<?php echo assets_url(); ?>/assets/img/defacto-2022.png"
              alt=""
            />
            <img
              class="lazyload awards-britishtravel"
              src="<?PHP echo assets_url(); ?>/assets/img/loader_352_198.gif"
              data-src="<?php echo assets_url(); ?>/assets/img/BTA2020_new.png"
              alt=""
            />
          </div>
        </div>
          ...
          <section class="what-customer-say home-page-section">
            <div class="container d-md-flex align-items-center h-100">
              <div class="hero-details">
                ...
                <a href="/" class="btn btn-secondary btn-bold mt-3">
                  <i class="fas fa-caret-right"></i> get quote
                </a>
              </div>
